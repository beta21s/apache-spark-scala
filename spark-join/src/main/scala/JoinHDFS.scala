...
import breeze.util.{BloomFilter, deserializeFromBytes}
...
//    rs += ", Time: " + (System.currentTimeMillis() - startTimeMillis) / 1000
    ...
    Seq("")
      ...
      .parquet("hdfs://172.20.9.30:9000/result/hdfs-cluster.parquet")
    ...
    // Doc
    spark.read.parquet("hdfs://172.20.9.30:9000/result/hdfs-cluster.parquet").show()
